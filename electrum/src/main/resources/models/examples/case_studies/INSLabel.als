...
}
{
  ...
  all n: nodes | all /* disj */ c,c11: n.children |
    c.label != c11.label
...
}
{
  ...
  all a: anodes | all disj v,v11: a.children |
    (no v.*children.recs & v11.*children.recs)
}
  ...
  all q: Query | all a: Advertisement |
    all nq: Node | all na: Node |
      q.ConformsAux[a,nq,na] <=>
      {
       ...
       all nq11: q.children[nq] | some na11: a.children[na] |
         q.ConformsAux[a,nq11,na11]
      }
}
